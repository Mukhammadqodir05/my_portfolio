      ...
      <main className="flex  flex-col justify-center items-center text-center h-screen w-full overflow-hidden">
        <div className="container_color flex flex-col space-y-7 h-screen w-full justify-center items-center">
          <h1 className="text-2xl">𝚂𝚊𝚢 𝚑𝚎𝚕𝚕𝚘!</h1>
           <input className="border-b bg-transparent outline-none pl-10 pb-1"placeholder=" typing is optional!"/>
           <Link to='/main'>
             <button className="flex justify-center button p-2 w-[130px] rounded-md hover:scale-90 duration-300"><span className="text-4xl">🏠</span></button>
           </Link>
           </div>
